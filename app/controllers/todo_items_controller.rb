class TodoItemsController < ApplicationController
  ...
  def create
      ...
      respond_to do |format|
        if @todo_item.save
          format.html { redirect_to todo_list_todo_items_path(@todo_item), notice: "Todo item was successfully created." }
  ...
  def update
    respond_to do |format|
      if @todo_item.update(todo_item_params)
        format.html { redirect_to todo_list_todo_items_url(@todo_item), notice: "Todo item was successfully updated." }
